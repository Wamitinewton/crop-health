...
import 'package:farmshield/feature_message/constants/formate_date.dart';
...
import 'package:farmshield/feature_message/models/chat_data_model.dart';
                    ...
                    leading: Stack(children: [
                      CircleAvatar(
                        backgroundImage: otherUser.profilePic == "" ||
                            ...
                            : CachedNetworkImageProvider(
                                "https://cloud.appwrite.io/v1/storage/buckets/66ed4154003a4065ef76/files/${otherUser.profilePic}/view?project=66ed2752001a89f99303&mode=admin"),
                      ),
                      Positioned(
                        right: 0,
                        bottom: 0,
